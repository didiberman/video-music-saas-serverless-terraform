    ...
    return (
        <main className="min-h-screen w-full bg-[#050505] text-white p-6 md:p-12 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 relative z-10 max-w-7xl mx-auto">
                ...
                {/* 1. All Users */}
                <div className="lg:col-span-3 rounded-2xl bg-[#0a0a0a] border border-white/5 overflow-hidden flex flex-col h-[500px] mb-8">
                    ...
                    <div className="flex-1 overflow-x-auto">
                        <table className="w-full text-left text-sm text-white/70">
                            <thead className="text-xs text-white/50 uppercase bg-white/5 border-b border-white/5 font-medium">
                                <tr>
                                ...
                                {users.map(u => (
                                    <tr key={u.uid} className="hover:bg-white/[0.02] transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className={`px-2 py-1 rounded text-xs font-medium ${u.credits && u.credits > 0 ? 'bg-violet-500/10 text-violet-400' : 'bg-red-500/10 text-red-400'
                                                }`}>
                                                {u.credits || 0} CR
                                            </span>
                                        </td>
                                        ...
                                        <td className="px-6 py-4 text-xs font-mono text-white/30 truncate max-w-[100px]" title={u.uid}>
                                            {u.uid}
                                        </td>
                                    </tr>
                                ))}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:col-span-3">
                    {/* 2. Live Generations */}
                    <div className="rounded-2xl bg-[#0a0a0a] border border-white/5 overflow-hidden flex flex-col h-[600px]">
                        <div className="p-6 border-b border-white/5 flex items-center justify-between">
                            <h2 className="font-semibold flex items-center gap-2">
